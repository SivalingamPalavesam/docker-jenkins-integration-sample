 ...
 * @Entity
 * 
 * @Table(name="account") public class Account {
 * 
 * @Id
 * 
 ...
 * 
 * @Column(name = "date_opened") private String dateOpened;
 * 
 * public Account() { super(); }
 * 
 * public Account(Integer id, int balance, String accountName, String
 * dateOpened) { super(); this.id = id; this.balance = balance; this.accountName
 * = accountName; this.dateOpened = dateOpened; }
 * 
